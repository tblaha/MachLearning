...
h = figure('Position', [100 100 800 500], 'Visible', 'off');
...
% best option
[best_score_ori, best_idx] = max(correct);
best_ori = actual_permutes(best_idx,:);
...
% best option
[best_score_cyl, best_idx] = max(correct);
best_cyl = actual_permutes(best_idx,:);
